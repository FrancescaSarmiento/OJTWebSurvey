                                    ...
                                    echo "<form action='editAccount.php?id=$id' method='POST'>";
                                        echo
                                             "<div class='row'>
                                                 <div class='form-group'>
                                                    <div class='col-lg-6'>
                                                       <label class='editAccount'>Employee Number: <em>".$row['empNum']."</em></label>
                                        ...
                                        echo
                                             "<div class='row'>
                                                 <div class='form-group'>
                                                    <div class='col-lg-6'>
                                                        <label class='editAccount'>Lastname: <em>".$row['lastName']."</em></label>
                                        ...
                                        echo
                                             "<div class='row'>
                                                 <div class='form-group'>
                                                    <div class='col-lg-6'>
                                                        <label class='editAccount'>Firstname: <em>".$row['firstName']."</em></label>
                                        ...
                                        echo
                                             "<div class='row'>
                                                 <div class='form-group'>
                                                    <div class='col-lg-6'>
                                                        <label class='editAccount'>E-mail Address: <em>".$row['email']."</em></label>
                                        ...
                                        echo
                                             "<div class='row'>
                                                 <div class='form-group'>
                                                    <div class='col-lg-6'>
                                                        <label class='editAccount'>Department: <em>".$row['department']."</em></label>
                                        ...
                                        echo
                                             "<div class='row'>
                                                 <div class='form-group'>
                                                    <div class='col-lg-6'>
                                                        <label class='editAccount'>Team: <em>".$row['team']."</em></label>
                                        ...
                                        echo
                                            "<div class='row'>
                                                    <div class='form-group'>
                                                        <div class='col-md-6'>
                                                            <label class='editAccount'>User Role: <em>".$row['type']."</em> </label>   
                                                       </div>    
                                                    </div>
                                                 </div>";
                                        ...
                                        echo 
                                                "<div class='row'>
                                                    <div class ='form-group'>
                                                    <div class='col-lg-11'>
                                                        <a href='manage.php'><button type='button' class='btn btn-default btn-lg cancel font'>Cancel</button></a>
                                                    </div>
                                                    <div class='col-lg-1'>
                                                        <button type='submit' name='submit' class='btn btn-default btn-lg done font'>Done</button>
                                                    </div>
