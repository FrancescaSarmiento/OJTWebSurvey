                        ...
                        ?>   
                                    ...
                                    <div class = "form-group">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <input type="hidden" class="form-control" name="num['<?php echo "" . $row['questionId'] . ""; ?>']"  value="<?php echo "" . $row['questionId'] . ""; ?>">
                                        </div> 
                                        ...
                                        <?php
                                                ...
                                                echo "<div class='col-xs-1'>
                                                        <button type='submit' class='btn btn-default btn-sm' name='delQ' ><i class='fa fa-trash-o' aria-hidden='true'></i></button>
                                                        <input type='hidden' name ='delQuest' value='$temp' >
                                                    </div>";
