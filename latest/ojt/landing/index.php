...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a href="../landing/index.php"><img src="../landing/img/lg.png" class="navbar-brand topnav size" alt="logo"></a>
                <a class="navbar-brand topnav branding" href="../landing/index.php">NTU SURVEY</a>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                            <li>
                                <a href="../login/index.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-pawn"></i> <span class="network-name">Answer a Survey </span></a>
                            </li>
                            <li>
                                <a href="../login/index.php" class="btn btn-default btn-lg"><i class="glyphicon glyphicon-pencil"></i> <span class="network-name">Create a Survey</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <h2 class="section-heading">We are NTU<br><span style="font-size:20px">The Nobility</span></h2>
                    <p class="lead">We are NTU, a 100% Filipino-owned and operated corporation that provides quality outsourced customer contact services and superior client experience from telemarketing and sales, customer service acquisition and retention and to a wide range of back-office management and administrative services – customized and tailor-fit to each client specification.</p>
                </div>
    ...
    <div class="banner">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2>Start exploring the Surveys!</h2>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="copyright text-muted small">Copyright &copy; OJT-Interns 2017. Saint Louis University - SCIS. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer>
