                        ...
                        ?>            
                            ...
                            <?php
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    $response = "INSERT INTO response( userId, surveyId) VALUES ('$userId','$surveyId')"; 
                                    
                                    if ($ntu_survey->query($response) === TRUE){
                                        ...
                                        foreach($ch as $c => $values){
                                            $sql = "INSERT INTO answer( questionId, choiceId, responseId) VALUES ('$c', '$values[0]','$resId')";      
                                            
                                            if ($ntu_survey->query($sql) === TRUE){

                                                $date = date('Y-m-d H:i:s');
                                                $sql1 = "INSERT INTO surveylog (date, actionSurvey, user) VALUES (CONVERT_TZ('$date', '+00:00', '+8:00'),'Answered Survey Titled "."$surveyTitle"." ','$userId')";  
                                         ...
                                         echo "Error: " . $response . "<br>" . $ntu_survey->error;
                                    }
