                                    ...
                                    if ($result=mysqli_query($ntu_survey, $survey)) {
                                        if(mysqli_num_rows($result) > 0) {
                                            while ($row=mysqli_fetch_row($result)) {
                                                ...
                                                echo "<td class='text-center'><form action='survey.php' method='POST'><a href='#' class='btn btn-default' role='button' name='analyze'><i class='fa fa-bar-chart' aria-hidden='true'></i></a></form></td>";
                                                ...
                                                echo "<td class='text-center'>
                                                            <form action='survey.php' method='POST'>
                                                                <input type='hidden' name='sId' value='$row[3]'>
                                                                 <a href='editSurvey.php'><button type='button' class='btn btn-default' name='edit'><i class='fa fa-pencil' aria-hidden='true'></i></button></a>
                                                            </form>
                                                      </td>";
                                                echo "</tr>";
